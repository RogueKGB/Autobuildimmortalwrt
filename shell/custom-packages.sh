...
CUSTOM_PACKAGES="$CUSTOM_PACKAGES luci-app-adbyby-plus luci-i18n-adbyby-plus-zh-cn"
CUSTOM_PACKAGES="$CUSTOM_PACKAGES luci-app-advanced"
CUSTOM_PACKAGES="$CUSTOM_PACKAGES apinger-rrd luci-app-apinger" 
CUSTOM_PACKAGES="$CUSTOM_PACKAGES luci-app-control-webrestriction luci-i18n-control-webrestriction-zh-cn"
CUSTOM_PACKAGES="$CUSTOM_PACKAGES luci-app-control-weburl luci-i18n-control-weburl-zh-cn"
CUSTOM_PACKAGES="$CUSTOM_PACKAGES luci-app-my-dnshelper luci-i18n-my-dnshelper-zh-cn"
...
CUSTOM_PACKAGES="$CUSTOM_PACKAGES luci-app-nft-timecontrol luci-i18n-nft-timecontrol-zh-cn"
CUSTOM_PACKAGES="$CUSTOM_PACKAGES luci-app-oaf luci-i18n-oaf-zh-cn"
CUSTOM_PACKAGES="$CUSTOM_PACKAGES luci-app-onliner"
CUSTOM_PACKAGES="$CUSTOM_PACKAGES polipo luci-app-polipo luci-i18n-polipo-zh-cn"
CUSTOM_PACKAGES="$CUSTOM_PACKAGES luci-app-poweroff luci-i18n-poweroff" 
...
CUSTOM_PACKAGES="$CUSTOM_PACKAGES wrtbwmon luci-wrtbwmon"
